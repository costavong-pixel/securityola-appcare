...
def test_sqlite_database_bootstrap_installs_audit_triggers() -> None:
    ...
    assert names == {
        ...
        "appcare_capability_evidence_no_update",
        "appcare_capability_evidence_no_delete",
        "appcare_supportability_decisions_no_update",
        "appcare_supportability_decisions_no_delete",
        "appcare_readiness_levels_no_update",
        "appcare_readiness_levels_no_delete",
        "appcare_readiness_downgrades_no_update",
        "appcare_readiness_downgrades_no_delete",
        "appcare_security_gate_decisions_no_update",
        "appcare_security_gate_decisions_no_delete",
    }
