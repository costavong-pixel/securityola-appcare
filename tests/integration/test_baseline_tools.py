...
def test_task_packet_seal_requires_scope_and_preserves_exact_bytes(tmp_path: Path) -> None:
    ...
    packet.write_bytes(
        b"TARGET=AppCare\n"
        b"Phase: P02\n"
        b"Issue: APPCARE-READINESS\n"
        b"Goal: validate the worker packet boundary\n"
        b"Coding lane: SPARK\n"
        b"Worker host: CODEX_RUNTIME\n"
        b"Model provider: OPENAI_INCLUDED_CODEX\n"
        b"Codex Spark quota involved: YES\n"
        b"OpenAI API involved: NO\n"
        b"DeepSeek API involved: NO\n"
        b"Repository root: .\n"
        b"Branch: codex/test\n"
        b"Expected base SHA: 0123456789abcdef0123456789abcdef01234567\n\n"
...
def test_task_packet_seal_rejects_missing_scope(tmp_path: Path) -> None:
    ...
    packet.write_text(
        ...
        "Goal: validate the worker packet boundary\n"
        "Coding lane: SPARK\n"
