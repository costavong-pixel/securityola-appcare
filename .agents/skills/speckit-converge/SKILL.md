...
**Check for extension hooks (report only; never execute automatically) (before convergence)**:
...
- For each executable hook, output the following based on its `optional` flag:
  ...
  - **Mandatory hook** (`optional: false`):
    ...
    **Automatic Pre-Hook**: {extension}
    ...
    Do not run the hook; report it to Codex for explicit approval before proceeding to the Goal.
    ```
